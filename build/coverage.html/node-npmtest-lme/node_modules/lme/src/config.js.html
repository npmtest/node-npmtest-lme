...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-lme/node_modules/lme/src/config.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-lme/node_modules/lme/src/config.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-lme/node_modules/lme/src/</a> &#187; config.js</div>
</div>
<div class="body">
...
function buildChalkFunction(config) {
	...
	for (var outputMethod in config) {
		<span class="missing-if-branch" title="else path not taken" >E</span>if (config.hasOwnProperty(outputMethod)) {
			var colorFunc = chalk;
			...
			try {
				...
				<span class="missing-if-branch" title="if path not taken" >I</span>if (typeof colorFunc === 'undefined') {
<span class="cstat-no" title="statement not covered" >					throw new Error('Unsupported colorFunc');</span>
				}
				chalkColors[outputMethod] = colorFunc;
			} catch (err) {
<span class="cstat-no" title="statement not covered" >				console.log('Error setting style for ' + outputMethod + '. Will use default style.');</span>
			}
		}
	}
	return chalkColors;
...
&nbsp;
<span class="missing-if-branch" title="else path not taken" >E</span>if (!providedConfig.colors) {
	providedConfig = {
		colors: {
			logs: {},
			lines: {}
